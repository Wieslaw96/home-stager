      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#1E1E1B] rounded-2xl border border-white/8 p-8">
          ...
          <div className="my-5 flex items-center gap-3">
            ...
            <span className="text-xs text-[#F0EDE8]/30">lub</span>
            <div className="flex-1 h-px bg-white/6" />
          </div>

          <button
            onClick={handleGoogle}
            className="w-full border border-white/10 rounded-xl py-2.5 text-sm font-medium text-[#F0EDE8]/70 hover:bg-white/5 hover:text-[#F0EDE8] bg-[#252521] transition-all flex items-center justify-center gap-2"
          >
